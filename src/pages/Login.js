                ...
                <div className="auth-card">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="form-group">
                            ...
                            <input id="password" type="password" className="form-input" placeholder="••••••••" value={formData.password} onChange={function (e) { return setFormData(__assign(__assign({}, formData), { password: e.target.value })); }} required/>
                        </div>
                    ...
                    <div className="auth-footer">
                        <p className="auth-link-text">
                            ...
                            <react_router_dom_1.Link to="/signup" className="auth-link">Sign up</react_router_dom_1.Link>
                        </p>
