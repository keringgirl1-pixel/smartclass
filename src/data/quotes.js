...
exports.inspirationalQuotes = void 0;
exports.getRandomQuote = getRandomQuote;
exports.getQuoteByCategory = getQuoteByCategory;
exports.getQuoteOfTheDay = getQuoteOfTheDay;
exports.inspirationalQuotes = [
    // Goals
    {
...
function getRandomQuote() {
    return exports.inspirationalQuotes[Math.floor(Math.random() * exports.inspirationalQuotes.length)];
}
/**
 * Get quote by category
 */
function getQuoteByCategory(category) {
    var filtered = exports.inspirationalQuotes.filter(function (q) { return q.category === category; });
...
function getQuoteOfTheDay() {
    ...
    var hash = today.split('').reduce(function (acc, char) { return acc + char.charCodeAt(0); }, 0);
    var index = hash % exports.inspirationalQuotes.length;
    return exports.inspirationalQuotes[index];
}
exports.default = exports.inspirationalQuotes;
